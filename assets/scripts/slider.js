// Grabbed from the WAI ARIA patterns for multi Thumb slider. with all the functionallity built in.
// I styled and customized it for our need
...
class SliderMultithumb {
  constructor(domNode) {
    ...
    this.focusOffset = 3;
    this.focusY = this.valueTop - this.valueHeight - this.focusOffset - 12;
    this.focusWidth = this.thumbWidth + 2 * this.focusOffset;
    this.focusHeight = this.thumbBottom - this.focusY + this.focusOffset - 3;
  ...
  moveSliderTo(sliderNode, value) {
    ...
    this.rangeNode.setAttribute('width', Math.abs(width));
  }
